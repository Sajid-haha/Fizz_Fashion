...
function get_unique_categories(){
    ...
    if(isset($_GET['category'])){
        ...
        $select_query = "SELECT * FROM `products` WHERE category_id=(SELECT category_id FROM categories WHERE category_title='$category_title')";
           $result_query=mysqli_query($con,$select_query);
...
function get_unique_brands(){
    ...
    if(isset($_GET['brand'])){
        ...
        $select_query = "SELECT * FROM `products` WHERE brand_id=(SELECT brand_id FROM brands WHERE brand_title='$brand_title')";
           $result_query=mysqli_query($con,$select_query);
           $num_of_rows=mysqli_num_rows($result_query);
           if($num_of_rows==0){
...
function search_product(){
    ...
    $search_query="Select * from `products` where product_keywords like '%$search_data_value%'";
            ...
            $num_of_rows=mysqli_num_rows($result_query);
           if($num_of_rows==0){
            echo"<h2 class='text-center text-danger'>This product is not available for service</h2>";
           }
            while($row=mysqli_fetch_assoc($result_query)){
                $product_id=$row['product_id'];
                $product_title=$row['product_title'];
...
function view_details(){
    ...
    $select_query="Select * from `products` where product_id=$product_id";
            ...
            <div class='row'>
                <div class='col-md-10'>
                    <h3 class='text-center text-info mb-5'><u>Related Products</u> </h3>
                </div>
                ...
                <div class='col-md-4'>
                <img src='./admin_area/product_images/$product_image4' class='card-img-top' alt='$product_title'>
                </div>
